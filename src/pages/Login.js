    ...
    >
      ...
      <div className="relative z-10 max-w-md w-full px-8">
        <div className="text-center mb-12">
          <h1
            className="text-6xl font-mono font-bold uppercase tracking-tighter text-white mb-4"
            data-testid="login-title"
          >
            TITANOS
          </h1>
          <p
            className="text-zinc-400 text-sm uppercase tracking-wider font-mono"
        ...
        <div className="bg-[#121214] border border-zinc-800 p-8 rounded-sm">
          <h2
            className="text-2xl font-mono font-semibold text-white mb-6 uppercase tracking-tight"
          ...
          <p
            className="text-xs text-zinc-600 text-center mt-6 font-mono"
        ...
        <div className="mt-8 text-center">
          <p
            className="text-xs text-zinc-600 uppercase tracking-wider font-mono"
